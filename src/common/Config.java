...
public class Config {
    ...
    public final static int FONT_SIZE=140;//字体大小
    public final static int FONT_COLOR_MIN_RED=100;//字体颜色
    public final static int FONT_COLOR_MIN_GREEN=100;
    public final static int FONT_COLOR_MIN_BLUE=100;
    public final static float GREY_WEIGHT_RED=0.3f;
    public final static float GREY_WEIGHT_GREEN=0.3f;
    public final static float GREY_WEIGHT_BLUE=0.3f;
}
